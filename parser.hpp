...
typedef enum {TAG_START, TAG_H6, TAG_H5, TAG_H4, TAG_H3, TAG_H2, TAG_H1, TAG_H0, TAG_BOLD_ITALIC, TAG_BOLD, TAG_ITALIC, TAG_U, TAG_CLOSE, TAG_NOTE, TAG_DEF, TAG_EXAMPLE, TAG_THEOREM, TAG_PROOF, TAG_QUOTE, TAG_CODE_INLINE, TAG_CODE_BLOCK, TAG_LATEX_MULTILINE, TAG_LATEX_INLINE, TAG_IMG, TAG_CENTER, TAG_UL, TAG_OL, TAG_CHECK, TAG_CROSS, TAG_BLUE, TAG_QED, TAG_END} tag;
